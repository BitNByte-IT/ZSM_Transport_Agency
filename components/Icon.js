export default function Icon({ name, className = "w-6 h-6" }) {
  ...
  return (
    <svg
      ...
      className={className}
    >
      <path d="M21.5 3.5L2.9 10.7c-1.3.5-1.3 1.2-.2 1.5l4.8 1.5 1.8 5.7c.2.6.1.8.8.8.5 0 .7-.2 1-.5l2.3-2.2 4.8 3.5c.9.5 1.5.2 1.8-.8l3.4-16c.4-1.3-.5-1.9-1.9-1.3zM8.3 13.3l10-6.3c.5-.3.9-.1.5.3l-8.2 7.4-.3 3.3z" />
    </svg>
  );
    case "person":
      return (
